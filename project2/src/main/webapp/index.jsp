...
<body>
        ...
        <div class="inner">
            ...
            <ul id="gnb">
              <% if (session.getAttribute("userId") != null) { %>
                <li><a href="member/list.jsp">게시판</a></li>
                 <% } else { %>
                 <li><a href="login_main.jsp" onclick="showLoginAlert()">게시판</a></li>
                 <% } %>
            </ul>
           ...
           <ul class="util">
                <% if (session.getAttribute("userId") != null) { %>
	                ...
	                <li><a href="member/member_update_form.jsp">정보수정</a></li>
                <% } else { %>
   ...
   <script>
        function showLoginAlert() {
            alert("로그인이 필요합니다.");
            // 로그인 페이지로 이동하도록 변경하려면 아래 주석을 해제하세요.
